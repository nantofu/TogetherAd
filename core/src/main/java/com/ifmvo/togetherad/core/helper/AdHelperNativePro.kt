...
class AdHelperNativePro(
  ...
  companion object {
    ...
    fun show(
      ...
      @NotNull nativeTemplate: BaseNativeTemplate,
  ...
  private fun getListForMap(
    @NotNull ratioMap: LinkedHashMap<String, Int>,
    listener: NativeListener? = null
  ) {
    ...
    adProvider?.getNativeAdList(mActivity.get()!!, adProviderType, mAlias, currentMaxCount,
