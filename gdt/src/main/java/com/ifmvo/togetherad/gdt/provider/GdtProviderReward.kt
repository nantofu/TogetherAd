...
abstract class GdtProviderReward : GdtProviderNativeExpress2() {
  ...
  override fun requestRewardAd(
    ...
    rewardVideoAD =
      RewardVideoAD(activity, TogetherAdGdt.idMapGDT[alias], object : RewardVideoADListener {
        ...
        override fun onReward(map: MutableMap<String, Any>?) {
          map?.let {
            GdtProvider.Reward.verificationOption = it[ServerSideVerificationOptions.TRANS_ID]
          }
