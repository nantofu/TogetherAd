...
import kotlinx.android.synthetic.main.activity_inter.btnRequest
import kotlinx.android.synthetic.main.activity_inter.btnShow
import kotlinx.android.synthetic.main.activity_inter.info
import kotlinx.android.synthetic.main.activity_inter.log
...
class InterActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    adHelperInter =
      AdHelperInter(activity = this, alias = TogetherAdAlias.AD_INTER, /*ratioMap = ratioMapInter,*/
        listener = object : InterListener {
