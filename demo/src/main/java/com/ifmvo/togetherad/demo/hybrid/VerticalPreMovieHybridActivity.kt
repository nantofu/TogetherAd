...
import kotlinx.android.synthetic.main.activity_vertical_premovie.adContainer
import kotlinx.android.synthetic.main.activity_vertical_premovie.btnRequestAndShow
import kotlinx.android.synthetic.main.activity_vertical_premovie.info
import kotlinx.android.synthetic.main.activity_vertical_premovie.log
...
class VerticalPreMovieHybridActivity : AppCompatActivity() {
  ...
  private val adHelper by lazy {
    ...
    AdHelperHybridVerticalPreMovie(
      this, TogetherAdAlias.AD_HYBRID_VERTICAL_PREMOVIE, adContainer,
      ratioMapVerticalPreMovie
    )
  }
