...
import kotlinx.android.synthetic.main.activity_native_recyclerview.recyclerView
...
class NativeExpress2RecyclerViewActivity : AppCompatActivity() {
  ...
  private val adHelperNativeExpress2Rv by lazy {
    AdHelperNativeExpress2(
      this,
      TogetherAdAlias.AD_NATIVE_EXPRESS_2_RECYCLERVIEW, /*ratioMapNativeRecycler,*/ 3
    )
  }
   ...
   * 具体逻辑按照自己的需求自行处理
   */
  private fun mergeContentAd(
    contentList: List<ContentDataEntity>,
    adList: List<Any>
  ): List<Any> {
  ...
  private fun getContentData(): List<ContentDataEntity> {
    ...
    for (index in 1..15) {
      ...
      contentList.add(
        ContentDataEntity(
          title = title,
          imgUrl = "https://t8.baidu.com/it/u=2247852322,986532796&fm=79&app=86&size=h300&n=0&g=4n&f=jpeg?sec=1590128472&t=657ec840a5c6c658430135ea8b1d35f0"
        )
      )
    }
    return contentList
