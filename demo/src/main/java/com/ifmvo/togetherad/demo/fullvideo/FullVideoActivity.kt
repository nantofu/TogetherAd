...
import kotlinx.android.synthetic.main.activity_reward.btnRequest
import kotlinx.android.synthetic.main.activity_reward.btnShow
import kotlinx.android.synthetic.main.activity_reward.info
import kotlinx.android.synthetic.main.activity_reward.log
...
class FullVideoActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
     ...
     */
    adHelperFullVideo = AdHelperFullVideo(activity = this,
      alias = TogetherAdAlias.AD_FULL_VIDEO, /*ratioMap = ratioMapFullVideo,*/
      listener = object : FullVideoListener {
