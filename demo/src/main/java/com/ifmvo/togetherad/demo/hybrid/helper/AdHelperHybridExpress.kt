...
class AdHelperHybridExpress(
  ...
  companion object {
    ...
    fun show(
      @Nullable adProviderType: String?,
      @NotNull activity: Activity,
      ...
      when (adProviderType) {
        ...
        AdProviderType.CSJ.type -> {
          AdHelperNativeExpress2.show(activity, adObject, container, NativeExpress2TemplateSimple(),
  ...
  private fun getHybridExpressListForMap(
    @NotNull ratioMap: LinkedHashMap<String, Int>,
    listener: NativeExpress2Listener? = null
  ) {
  ...
  private fun getHybridExpressList(
  ...
  private fun getHybridExpress2List(
    adProviderType: String,
    currentAdCount: Int,
    listener: NativeExpress2Listener?,
    ratioMap: LinkedHashMap<String, Int>
  ) {
    adProvider?.getNativeExpress2AdList(mActivity.get()!!, adProviderType, mAlias, currentAdCount,
      object : NativeExpress2Listener {
        override fun onAdLoaded(
          providerType: String,
          adList: List<Any>
        ) {
