...
import kotlinx.android.synthetic.main.activity_native_express_simple.adContainer
import kotlinx.android.synthetic.main.activity_native_express_simple.btnRequest
import kotlinx.android.synthetic.main.activity_native_express_simple.btnShow
import kotlinx.android.synthetic.main.activity_native_express_simple.info
import kotlinx.android.synthetic.main.activity_native_express_simple.log
...
class NativeExpress2SimpleActivity : AppCompatActivity() {
  ...
  private val adHelperNativeExpress2 by lazy {
    ...
    AdHelperNativeExpress2(
      this, TogetherAdAlias.AD_NATIVE_EXPRESS_2_SIMPLE, ratioMapNativeExpress2,
      1
    )
  }
  ...
  private fun showAd() {
    AdHelperNativeExpress2.show(this, mAdObject, adContainer, NativeExpress2TemplateSimple(),
      object : NativeExpress2ViewListener {
