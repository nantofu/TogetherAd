...
import kotlinx.android.synthetic.main.activity_native_simple.adContainer
import kotlinx.android.synthetic.main.activity_native_simple.btnRequest
import kotlinx.android.synthetic.main.activity_native_simple.btnShow1
import kotlinx.android.synthetic.main.activity_native_simple.btnShow2
import kotlinx.android.synthetic.main.activity_native_simple.btnShow4
import kotlinx.android.synthetic.main.activity_native_simple.btnShow5
import kotlinx.android.synthetic.main.activity_native_simple.info
import kotlinx.android.synthetic.main.activity_native_simple.log
...
class NativeSimpleActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    adHelperNative = AdHelperNativePro(
      activity = this, alias = TogetherAdAlias.AD_NATIVE_SIMPLE,
      maxCount = 1/*, ratioMap = ratioMapNativeSimple*/
    )
  ...
  private fun showAd(
    adObject: Any?,
    nativeTemplate: BaseNativeTemplate
  ) {
    if (adObject == null) return

    AdHelperNativePro.show(adObject = adObject, container = adContainer,
      nativeTemplate = nativeTemplate, listener = object : NativeViewListener {
