...
import kotlinx.android.synthetic.main.activity_banner.adContainer
import kotlinx.android.synthetic.main.activity_banner.btnRequestShow
import kotlinx.android.synthetic.main.activity_banner.info
import kotlinx.android.synthetic.main.activity_banner.log
...
class BannerActivity : AppCompatActivity() {
  ...
  private fun showBannerAd() {
    ...
    //设置 穿山甲 Banner 尺寸
    CsjProvider.Banner.setExpressViewAcceptedSize(
      px2dp(this, ScreenUtil.getDisplayMetricsWidth(this)),
      px2dp(this, ScreenUtil.getDisplayMetricsWidth(this) / 8)
    )

    AdHelperBanner.show(activity = this, alias = TogetherAdAlias.AD_BANNER,
      container = adContainer, /*ratioMap = ratioMapBanner,*/ listener = object : BannerListener {
