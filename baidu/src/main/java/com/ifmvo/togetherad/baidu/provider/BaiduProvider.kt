...
open class BaiduProvider : BaseAdProvider() {
  ...
  override fun getNativeAdList(
    ...
    val baidu = BaiduNative(activity, TogetherAdBaidu.idMapBaidu[alias],
  ...
  override fun requestRewardAd(
    ...
    mRewardVideoAd = RewardVideoAd(activity, TogetherAdBaidu.idMapBaidu[alias],
      object : RewardVideoAd.RewardVideoAdListener {
        override fun onAdFailed(errorMsg: String?) {
          "onAdFailed".loge(tag)
