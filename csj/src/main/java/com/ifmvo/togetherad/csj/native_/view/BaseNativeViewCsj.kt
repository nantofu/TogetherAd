...
abstract class BaseNativeViewCsj : BaseNativeView() {
  ...
  override fun showNative(
    ...
    getSourceTextView()?.text =
      if (adObject.source?.isNotEmpty() == true) adObject.source else "广告来源"
    ...
    adObject.registerViewForInteraction(rootView as ViewGroup,
      getClickableViews() ?: mutableListOf(), getCreativeViews() ?: mutableListOf(),
