...
abstract class CsjProviderInter : CsjProviderFullVideo() {
  ...
  override fun requestInterAd(
    ...
    TTAdSdk.getAdManager().createAdNative(activity)
      .loadInteractionExpressAd(adSlotBuilder.build(), object : TTAdNative.NativeExpressAdListener {
        override fun onNativeExpressAdLoad(adList: MutableList<TTNativeExpressAd>?) {
          ...
          mTTNativeExpressInterAd?.setExpressInteractionListener(object :
          ...
          mTTNativeExpressInterAd?.setDislikeCallback(activity,
