  ...
  override fun showBannerAd(
    ...
    val adSlot = AdSlot.Builder()
      ...
      .setExpressViewAcceptedSize(
        CsjProvider.Banner.expressViewAcceptedSizeWidth,
        CsjProvider.Banner.expressViewAcceptedSizeHeight
      )
    ...
    TTAdSdk.getAdManager().createAdNative(activity)
      .loadBannerExpressAd(adSlot, object : TTAdNative.NativeExpressAdListener {
        override fun onNativeExpressAdLoad(adList: MutableList<TTNativeExpressAd>?) {
          ...
          mTTNativeExpressBannerAd?.setExpressInteractionListener(object :
          ...
          mTTNativeExpressBannerAd?.setDislikeCallback(activity,
